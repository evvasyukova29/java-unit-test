...
public void checkIsAdultWhenAgeIsLessThan18False()
{
    ...
    assertEquals("Должно вернуться false, тесли пользователю меньше 18 лет,", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True()
{
    ...
    assertEquals("Должно вернуться true, тесли пользователю hjdyj 18 лет,", true, isAdult);
}